	...
	public class Bship extends JFrame
	{		
		...
		//array of numbers used for combo boxes
						 ships = {"Carrier","Bship","Submarine","Destroyer",
		...
		//variable that determines whether or not a Bship has been placed
				...
				for (j=0;j<11;j++)
				{
					...
					{				
						...
						{	
							...
							k= new JTextField(Bship.getCnumbers(j));
							k.setEditable(false);
					...
					{	
						k= new JTextField(Bship.getCletters(i));	
						k.setEditable(false);
						k.setHorizontalAlignment((int)JFrame.CENTER_ALIGNMENT); 
						players[n].getMyBoard().add(k);
					}				
		...
		private class ExitListener implements ActionListener
		{
			public void actionPerformed(ActionEvent e)
			{
				...
				+"ike to exit Bship?", "Exit?", JOptionPane.YES_NO_OPTION);
				if (r==0)
					System.exit(0);	
			}	
		}
		...
		public static BshipClient getClient()
		{
			return me;		
		}
	...
	JLabels?
	http://www.hasbro.com/common/instruct/BshipAdvancedMission.pdf
