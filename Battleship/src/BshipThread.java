...
public class BshipThread extends Thread {
	...
	public BshipThread(Socket socket) throws IOException{
		super("BshipThread");
		...
		{	
			...
			{				
				...
				{				  
					...
					results=BshipServer.getProtocol().results(x,y);
	...
	public void getShot()
	{
		try
			...
			//notifyAll();
			out.println(BshipServer.getProtocol().results(x,y));
	}
